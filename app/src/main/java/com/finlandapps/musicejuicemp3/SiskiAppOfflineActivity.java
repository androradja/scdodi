...
import com.finlandapps.musicejuicemp3.adapter.TrackAdapterOffline;
...
import static com.finlandapps.musicejuicemp3.SiskiAppSplashActivity.PERCODE;
...
//    public static String DB_PATH = Environment.getExternalStorageDirectory() + File.separator + "Downloads";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        new Ads(SiskiAppOfflineActivity.this).showBanner(banner);
