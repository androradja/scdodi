...
public class SiskiAppMusicPlayActivity extends AppCompatActivity implements SeekBar.OnSeekBarChangeListener {
...
//    RelativeLayout banner;
    ...
    SeekBar seekBar;
    AppCompatImageView rew, ff, repeat, share, library,  download;
...
//        }
        ...
        library.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(SiskiAppMusicPlayActivity.this, SiskiAppOfflineActivity.class);
                startActivity(i);
                finish();
            }
        });
            ...
            download.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.Q) {
                        request.setDestinationInExternalPublicDir(Environment.DIRECTORY_DOWNLOADS, trackTitle);
                    } else {
                        request.setDestinationInExternalFilesDir(getApplicationContext(), Environment.DIRECTORY_DOWNLOADS, trackTitle);
                    }
...
//                    });
            ...
            download.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(SiskiAppMusicPlayActivity.this, "This song are downloaded.", Toast.LENGTH_SHORT).show();
                }
            });
        }
    ...
    public void loadNewInter() {
        Ads ads = new Ads(SiskiAppMusicPlayActivity.this);
        ads.showinters();
        ...
        protected void onPostExecute(String result) {
            ...
            if (result != null) {
                ...
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (!Settings.System.canWrite(SiskiAppMusicPlayActivity.this)) {
